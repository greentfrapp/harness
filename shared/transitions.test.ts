...
describe('transition()', () => {
  ...
  const legalCases: [TaskStatus, TransitionAction, TaskStatus][] = [
    ...
    ['in_progress', 'propose_subtasks', 'subtasks_proposed'],
    ['in_progress', 'auto_approve_subtasks', 'waiting_on_subtasks'],
    ...
    // Subtask-driven
    ['subtasks_proposed', 'approve_subtasks', 'waiting_on_subtasks'],
    ['subtasks_proposed', 'dismiss_all_subtasks', 'queued'],
    ['subtasks_proposed', 'reject', 'rejected'],
    ['subtasks_proposed', 'revise', 'queued'],
    ['subtasks_proposed', 'cancel', 'cancelled'],
