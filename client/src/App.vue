  ...
  <div class="h-screen flex flex-col overflow-hidden">
    ...
    <header
      ...
      <div class="flex items-center gap-4">
        ...
        <Tooltip
          :text="events.connected ? 'Connected' : 'Disconnected'"
          position="bottom">
          <div
    ...
    <!-- Checkout banner -->
    <div
      v-if="checkoutsStore.hasCheckouts"
      class="bg-amber-950 border-b border-amber-900 px-6 py-2">
      <div
        v-for="co in checkoutsStore.checkouts"
        :key="co.taskId"
        class="space-y-2">
        <div class="flex items-center gap-3 text-sm">
          <span class="text-amber-400 font-medium shrink-0">Checked out</span>
          <span class="text-amber-200 truncate"
            >{{ co.projectName }}: {{ co.taskPrompt }}</span
          >
          <div class="ml-auto flex gap-2 shrink-0">
            ...
            <button
              ...
              @click="
                showReviseCheckout =
                  showReviseCheckout === co.taskId ? null : co.taskId
              ">
              Revise
            </button>
          </div>
        ...
        <div
          v-if="showReviseCheckout === co.taskId"
          ...
          <button
            ...
            :disabled="
              revisingCheckout === co.taskId || !reviseCheckoutPrompt.trim()
            "
