...
import { OUTBOX_STATUSES, DRAFT_STATUSES } from '@shared/types';
import { api } from '../api';
...
export const useOutbox = defineStore('outbox', () => {
  ...
  async function updateDraft(id: string, updates: { prompt?: string; priority?: string; type?: string }): Promise<Task> {
