import type { AgentAdapter, AgentProgressEvent } from './adapter'
...
export class ClaudeCodeAdapter implements AgentAdapter {
  ...
  private applyPermissionArgs(
    ...
    const effectiveMode =
      permissionMode ?? (usesWorktree ? 'bypassPermissions' : undefined)
  ...
  parseMessage(line: string): AgentProgressEvent | null {
    ...
    if (
      ...
      return {
        ...
        toolName: toolMatch?.[1] ?? base.toolName,
      }
    }
